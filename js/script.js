var app = {
  ...
  clickButton : function(controlButton) {
    controlButton.addEventListener('click', function(){
      if (hasClass(controlButton, 'active')) {
        controlButton.className = controlButton.className.replace(' active', '');
      } else {
  ...
  playPause : function() {
    ...
    var pleer = document.getElementById('player');
    var message;
    ...
    button.addEventListener('click', function(){
      if (hasClass(button, 'active')) {
        ...
        pleer.className = pleer.className.replace(' loading', '');
      } else {
        app.hideMessage();
        startCountdown();
        button.className += ' active';
        pleer.className += ' loading';
      }
    });
  ...
  fullScreen : function() {
    var button = document.getElementById('full-screen');
  ...
  showMessage : function() {
    ...
    var mediaArea = document.getElementById('media');

    mediaArea.className += ' error';
  ...
  hideMessage : function() {
    ...
    mediaArea.className = mediaArea.className.replace(' error', '');
  ...
  rangeSliders : function() {
    ...
    noUiSlider.create(videoTimeline, {
      start: [ 0 ],
      range: {
        'min': 0,
        'max': 2.83 * 60 * 60
